          ...
          <div className="flex flex-col justify-start mx-auto gap-2">
            <div className="flex flex-col gap-2">
              <div className="flex flex-col-reverse md:flex-row justify-start gap-2">
                ...
                <div className="h-20 flex items-center justify-between gap-4 border border-black dark:border-white rounded-lg px-4 empty:hidden">
              ...
              <form className="h-9 flex gap-2 items-center border border-black dark:border-white rounded-lg px-2 font-medium focus-within:ring-1 focus-within:ring-black dark:focus-within:ring-white w-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <table className="w-full border-collapse allowances-table">
                <thead>
                  <tr className="border-b border-black dark:border-white h-10">
                    ...
                    <th className="text-left px-2 whitespace-nowrap">
                      <div className="font-bold text-left">Approved Amount</div>
                    </th>
                    <th className="text-left px-2 whitespace-nowrap">
